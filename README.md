...
### 1. 目的与性质
本项目 (`lx-ikun-music-sources`) 旨在**收集、整理与分享音乐播放软件（如 LX Music、IKUN Music）的相关技术资源与信息**，**仅供个人学习、研究及技术交流使用**。
...
**详细条款请务必阅读：**[LICENSE.md](LICENSE.md)

### 3. 核心原则
- **尊重版权**：本项目鼓励支持正版音乐。所有资源均标注来源，如有侵权，请联系删除。
- **风险自担**：本项目不提供任何稳定性或安全性担保，不对使用后果负责。
- **禁止滥用**：请严格遵守所在地区的法律法规，合理使用本资源。
...
如果您有优质音源想要分享，欢迎通过以下方式提交：
- 📝 创建 Issue
- 🔄 提交 Pull Request  
- 📧 发送邮件至：Macrohard0001_m01@outlook.com

（如需咨询也可发送邮件，但可能无法及时回复）

如果这个项目对您有帮助，请给个免费的 Star 支持一下，谢谢！
...
- 支持软件	LX Music(及其所有修改版)，CyMusic，MusicFree(即将停止支持)，音乐下载器(com.ikunshare.music.downloader, com.mylrc.mymusic)
- 使用方法	请查看发布地址
- 限制	强网络限制地区必须使用IP版
...
**本资源仅供学习交流使用，请尊重版权，支持正版音乐。**  
**所有第三方服务均与本项目无关，请谨慎选择和使用。**

---

# 广告位招租，有意者联系QQ：3676299814商议
